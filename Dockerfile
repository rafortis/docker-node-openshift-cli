...
### NODE from https://github.com/nodejs/docker-node/blob/master/10/alpine/Dockerfile #####
...
### OPEN SHIFT  from https://github.com/saily/openshift-cli/blob/master/Dockerfile #####
ENV LANG=C.UTF-8
